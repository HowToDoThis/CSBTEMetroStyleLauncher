...
namespace MaterialSkin.Controls
{
    public class MaterialCheckBox : CheckBox, IMaterialControl
    {
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            boxRectangle = new Rectangle(RightCheck ? (int)textWidth + boxOffset : boxOffset, boxOffset, CHECKBOX_SIZE - 1, CHECKBOX_SIZE - 1);
        }

        public override Size GetPreferredSize(Size proposedSize)
        {
            int w = boxOffset + CHECKBOX_SIZE + 2 + 3 + (int)CreateGraphics().MeasureString(Text, SkinManager.ROBOTO_MEDIUM_10).Width;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if (RightCheck)
                boxRectangle = new Rectangle((int)textWidth + boxOffset, boxOffset, CHECKBOX_SIZE - 1, CHECKBOX_SIZE - 1);
            ...
            if (Ripple && rippleAnimationManager.IsAnimating())
            {
                for (int i = 0; i < rippleAnimationManager.GetAnimationCount(); i++)
                {
                    ...
                    var animationSource = new Point(RightCheck ? CHECKBOX_CENTER + (int)textWidth : CHECKBOX_CENTER, CHECKBOX_CENTER);
                    ...
                    var rippleHeight = (Height % 2 == 0) ? Height - 2 : Height - 2;
            ...
            var checkMarkLineFill = new Rectangle(RightCheck ? boxOffset + (int)textWidth : boxOffset, boxOffset, (int)(17.0 * animationProgress), 17);
            using (var checkmarkPath = DrawHelper.CreateRoundRect(RightCheck ? textWidth + boxOffset : boxOffset, boxOffset, 17, 17, 1f))
            {
                ...
                g.FillRectangle(
                    ...
                    RightCheck ? stringSize.Width + boxOffset + 2 : boxOffset + 2,
                    boxOffset + 2,
                    CHECKBOX_INNER_BOX_SIZE - 1,
                    CHECKBOX_INNER_BOX_SIZE - 1);
            ...
            g.DrawString(
                ...
                RightCheck ? 0 : boxOffset + TEXT_OFFSET,
