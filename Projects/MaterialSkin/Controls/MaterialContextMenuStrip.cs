...
namespace MaterialSkin.Controls
{
    public class MaterialContextMenuStrip : ContextMenuStrip, IMaterialControl
    {
        ...
        override public Size GetPreferredSize(Size proposedSize)
        {            
            ...
            return new Size(Convert.ToInt32((size.Width - 0) * 0.7), size.Height);
    ...
    public class MaterialToolStripMenuItem : ToolStripMenuItem
    {
        ...
        public MaterialToolStripMenuItem()
        {
            ...
            this.Font = new Font(SkinManager.ROBOTO_MEDIUM_10.FontFamily, 15);
        }
        ...
        {            
            ...
            return new Size(Convert.ToInt32(w * 0.7), size.Height);

            /*Size size = base.GetPreferredSize(proposedSize);

            return new Size(size.Width, size.Height + 8);*/
        }
    ...
    internal class MaterialToolStripRender : ToolStripProfessionalRenderer, IMaterialControl
    {
        ...
        protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
        {
            ...
            //g.FillRectangle(SkinManager.GetCmsSelectedItemBrush(), textRect);
        }
