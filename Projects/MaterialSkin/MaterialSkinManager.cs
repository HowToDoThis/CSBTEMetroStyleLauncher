...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        {
            return ((int)Primary.Red700).ToColor();
        }
        ...
        {
            FontFamily FONT_REGULAR = LoadFont(Resources.Font_Regular);
            FontFamily FONT_MEDIUM = LoadFont(Resources.Font_Medium);

            ROBOTO_MEDIUM_12 = new Font(FONT_MEDIUM, 12f);
            ROBOTO_MEDIUM_11 = new Font(FONT_MEDIUM, 11f);
            ROBOTO_MEDIUM_10 = new Font(FONT_MEDIUM, 10f);

            ROBOTO_REGULAR_10 = new Font(FONT_REGULAR, 10f);
            ROBOTO_REGULAR_11 = new Font(FONT_REGULAR, 11f);
